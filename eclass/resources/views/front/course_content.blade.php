                                                ...
                                                @if(!empty($progress))
                                                    @if($read_count == $total_count)
                                                        <div class="about-home-btn">
                                                            ...
                                                            <a href="{{ route('cirtificate.show', encrypt($course->id)) }}"
                                                               class="btn btn-secondary" href="#">Get Certificate</a>
                                                        </div>
                                                    @endif
                                                @endif
                                            </div>
                                                ...
                                                @if(isset($course->chapter[0]->courseclass[0]))
                                                    @if($course->chapter[0]->courseclass[0]->iframe_url == NULL)
                                                        ...
                                                        <a href="{{ route('watchcourse',$course->id) }}"
                                                           class="btn-video-play @if($z == 0)iframe @endif"><i
            ...
            <div class="about-block">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active text-center" id="nav-home-tab" data-toggle="tab"
                           href="#nav-home" role="tab" aria-controls="nav-home"
                           aria-selected="true">{{ __('frontstaticword.Overview') }}</a>
                        <a class="nav-item nav-link text-center" id="nav-profile-tab" data-toggle="tab"
                        ...
                        <a class="nav-item nav-link text-center" id="nav-live-tab" data-toggle="tab" href="#nav-live"
                           role="tab" aria-controls="nav-live"
                           aria-selected="false">{{ __('frontstaticword.LiveClass') }}</a>

                        <a class="nav-item nav-link text-center" id="nav-contact-tab" data-toggle="tab"
                           href="#nav-contact" role="tab" aria-controls="nav-contact"
                           aria-selected="false">{{ __('frontstaticword.Q&A') }}</a>
                        ...
                        <a class="nav-item nav-link text-center" id="nav-quiz-tab" data-toggle="tab" href="#nav-quiz"
                           role="tab" aria-controls="nav-quiz"
                           aria-selected="false">{{ __('frontstaticword.Quiz') }}</a>

                        @if($gsetting->assignment_enable == 1)
                            @if($course->assignment_enable == 1)
                                <a class="nav-item nav-link text-center" id="nav-assign-tab" data-toggle="tab"
                                   href="#nav-assign" role="tab" aria-controls="nav-assign"
                        ...
                        @if($gsetting->appointment_enable == 1)
                            @if($course->appointment_enable == 1)
                                <a class="nav-item nav-link text-center" id="nav-appoint-tab" data-toggle="tab"
                                   href="#nav-appoint" role="tab" aria-controls="nav-appoint"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <div class="section"><a href="#"
                                                                                                    title="questions">{{ $course->user->fname }} {{ $announsment->user->lname }}</a>
                                                                                <a href="#"
                                        ...
                                        <div class="content-course-number content-course-number-one">
                                            <div class="content-img-block btm-20">
                                                ...
                                                <div class="content-img-dtl">
                                                    <div class="profile"><a
                                                                ...
                                                                title="profile">{{ $course->user->fname }} {{ $course->user->lname }}
                                                        </a></div>
                                            ...
                                            <ul>
                                                ...
                                                @if($course->user->fb_url != NULL)
                                                    <li class="rgt-10"><a href="{{ $course->user['fb_url'] }}"
                                                                ...
                                                                <tr>
                                                                    <td width="10px">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input filled-in material-checkbox-input"
                                                                                   type="checkbox" name="checked[]"
                                                                                   value="{{$coursechapter->id}}"
                                                                                   id="checkbox{{$coursechapter->id}}" {{ isset($progress->mark_chapter_id) && in_array($coursechapter->id, $progress->mark_chapter_id) ? "checked" : "" }} >
                                                                    ...
                                                                    <td>
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-6">
                                                                                <div class="section">{{ __('frontstaticword.Section') }}
                                                                                    : <?php echo $i;?></div>
                                                                            </div>
                                                                            <div class="col-lg-6 col-6">
                                                                                <div class="section-dividation text-right">
                                                        ...
                                                        <div class="card-body">
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="class-type">
                                                                        @if($class->type =='video' && $class->video )
                                                                            <a href="{{ route('watchcourseclass',$class->id) }}"
                                                                               title="Course"
                                                                               class="@if($z == 0)iframe @endif"><i
                                                                                        class="fa fa-play-circle"></i>&nbsp;{{ __('frontstaticword.class') }}
                                                                            </a>
                                                                        ...
                                                                        @if($class->type =='image' && $class->image )
                                                                            <a href="{{ asset('images/class/'.$class->image) }}"
                                                                               ...
                                                                               title="Course"><i
                                                                                        class="fas fa-image"></i>&nbsp;{{ __('frontstaticword.save') }}
                                                                            </a>
                                                                        @endif
                                                                        @if($class->type =='pdf' && $class->pdf )
                                                                            <a href="{{route('downloadPdf',$class->id)}}"
                                                                               title="Course" class="iframe"><i
                                                                                        class="fas fa-file-pdf"></i>&nbsp;{{ __('frontstaticword.save') }}
                                                                            </a>
                                                                        ...
                                                                        @if($class->type =='zip' && $class->zip )
                                                                            <a href="{{ asset('files/zip/'.$class->zip) }}"
                                                                               download="{{$class->zip}}"
                                                                               title="Course"><i
                                                                                        class="far fa-file-archive"></i>&nbsp;{{ __('frontstaticword.save') }}
                                                                            </a>
                                                                        @endif
                                                                        @if($class->url)
                                                                            @if($class->type =='video')
                                                                            ...
                                                                            @if($class->type =='image')
                                                                                <a href="{{ $class->url }}"
                                                                                   title="Course"><i
                                                                                            class="fas fa-image"></i>&nbsp;{{ __('frontstaticword.link') }}
                                                                                </a>
                                                                            @endif
                                                                            @if($class->type =='pdf')
                                                                                <a href="{{ $class->url }}"
                                                                                   title="Course"><i
                                                                                            class="fas fa-file-pdf"></i>&nbsp;{{ __('frontstaticword.link') }}
                                                                                </a>
                                                                            @endif
                                                                            @if($class->type =='zip')
                                                                                <a href="{{ $class->url }}"
                                                                    ...
                                                                    <td class="class-name">
                                                                        <a href="#"
                                                                           title="Course">{{ $class->title }}</a>&nbsp;
                                                                        @if($class->date_time != NULL)
                                                                            <div class="live-class">Live
                                                                                at: {{ $class->date_time }}</div>
                                                                        @endif
                                                                    </td>
                                                            ...
                                                            @if($bbl->is_ended != 1)
                                                                ...
                                                                <div class="card btm-10">
                                                                    <div class="card-header"
                                                                         id="headingThree{{ $bbl->id }}">
                                                                        <div class="mb-0">
                                                                            <button class="btn btn-link"
                                                                                    data-toggle="collapse"
                                                                                    data-target="#collapseThree{{ $bbl->id }}"
                                                                                    aria-expanded="false"
                                                                                    ...
                                                                                    <ul>
                                                                                        <li><a href="#"
                                                                                               title="about">{{ __('frontstaticword.Created') }}
                                                                                                : @if(isset($bbl->user)) {{ $bbl->user['fname'] }} {{ $bbl->user['lname'] }} @endif</a>
                                                                                        </li>
                                                                                        <li><a href="#"
                                                                                               title="about">{{ __('frontstaticword.StartAt') }}
                                                                                                : {{ date('d-m-Y | h:i:s A',strtotime($bbl['start_time'])) }}</a>
                                                                                        </li>
                                                                                        ...
                                                                                        <li>
                                                                                            <a href=""
                                                                                               data-toggle="modal"
                                                                                               data-target="#myModalBBL"
                                                                                               title="join"
                                                                                               class="btn btn-light"
                                                                                               title="course">{{ __('frontstaticword.JoinMeeting') }}</a>
                                                                                        </li>
                                                                                                ...
                                                                                                <div class="modal-content">
                                                                                                    <div class="modal-header">
                                                                                                        ...
                                                                                                        <h4 class="modal-title"
                                                                                                            id="myModalLabel">{{ __('frontstaticword.JoinMeeting') }}</h4>
                                                                                                        <button type="button"
                                                                                                                class="close"
                                                                                                                data-dismiss="modal"
                                                                                                                aria-label="Close">
                                                                                                    ...
                                                                                                    <div class="box box-primary">
                                                                                                        <div class="panel panel-sum">
                                                                                                            <div class="modal-body">
                                                                                                                ...
                                                                                                                <form action="{{ route('bbl.api.join') }}"
                                                                                                                      method="POST">
                                                                                                                    @csrf
                                                        ...
                                                        <div class="faq-dtl">
                                                            <div id="accordion" class="second-accordion">
                                                                ...
                                                                @foreach($meetings as $meeting)
                                                                    ...
                                                                    <div class="card btm-10">
                                                                        <div class="card-header"
                                                                             id="headingFour{{ $meeting->id }}">
                                                                            <div class="mb-0">
                                                                                <button class="btn btn-link"
                                                                                        data-toggle="collapse"
                                                                                        data-target="#collapseFour{{ $meeting->id }}"
                                                                                        aria-expanded="false"
                                                                                        aria-controls="collapseFour">
                                                                        ...
                                                                        <div id="collapseFour{{ $meeting->id }}"
                                                                             class="collapse"
                                                                                    ...
                                                                                    <td>
                                                                                        <ul>
                                                                                            <li>
                                                                                                <a href="#"
                                                                                                   title="about">{{ __('frontstaticword.Created') }}
                                                                                                    : @if(isset($meeting->user)) {{ $meeting->user['fname'] }} {{ $meeting->user['lname'] }} @endif </a>

                                                                                            </li>
                                                                                            <li>
                                                                                                <p>Meeting
                                                                                                    Owner: {{ $meeting->owner_id }}</p>
                                                                                            </li>
                                                                                            <li>
                                                                                                <p class="btm-10"><a
                                                                                                            herf="#">{{ __('frontstaticword.StartAt') }}
                                                                                            ...
                                                                                            <li>
                                                                                                <a href="{{ $meeting->zoom_url }}"
                                                                                                   target="_blank"
                                                                                                   class="btn btn-light">{{ __('frontstaticword.JoinMeeting') }}</a>
                                                                                            </li>
                                                                                        </ul>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form id="demo-form2" method="post"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <label for="detail">{{ __('frontstaticword.Question') }}
                                            ...
                                            @foreach($questions as $ques)
                                                @if($ques->status == 1)
                                                    <div class="card btm-10">
                                                                ...
                                                                <button class="btn btn-link" data-toggle="collapse"
                                                                    ...
                                                                    <div class="row no-gutters">
                                                                        <div class="col-lg-6 col-8">
                                                                            <div class="section">
                                                                                <a href="#"
                                                                                   title="questions">{{ $ques->user->fname }} </a>
                                                                                <a href="#"
                                                            ...
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        ...
                                                                        <h4 class="modal-title"
                                                                            id="myModalLabel">{{ __('frontstaticword.Answer') }}</h4>
                                                                        <button type="button" class="close"
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <form id="demo-form2" method="post"
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <label for="detail">{{ __('frontstaticword.Answer') }}
                                                                                                :<sup class="redstar">*</sup></label>
                                                        ...
                                                        <div class="modal fade" id="myModalquesReport{{ $ques->id }}"
                                                             tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        ...
                                                                        <h4 class="modal-title"
                                                                            id="myModalLabel">{{ __('frontstaticword.Report') }}
                                                                            Question</h4>
                                                                        <button type="button" class="close"
                                                                                data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">&times;</span>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <form id="demo-form2" method="post"
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-md-6">
                                                                                            <div class="form-group">
                                                                                                <label for="title">{{ __('frontstaticword.Title') }}
                                                                                                    :<sup class="redstar">*</sup></label>
                                                                                                <input type="text"
                                                                                                       class="form-control"
                                                                                                       name="title"
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            <div class="form-group">
                                                                                                <label for="email">{{ __('frontstaticword.Email') }}
                                                                                                    :<sup class="redstar">*</sup></label>
                                                                                                <input type="email"
                                                                                                       class="form-control"
                                                                                                       name="email"
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                <label for="detail">{{ __('frontstaticword.Detail') }}
                                                                                                    :<sup class="redstar">*</sup></label>
                                                            ...
                                                            <div class="mb-0">
                                                                <button class="btn btn-link" data-toggle="collapse"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <div class="section"><a href="#"
                                                                                                    title="questions">{{ $announsment->user->fname }} {{ $announsment->user->lname }}</a>
                                                                                <a href="#"
                                                                                   title="questions">{{ date('jS F Y', strtotime($announsment->created_at)) }}</a>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-7">
                                                                                <ul class="topic-detail one-topic-detail">
                                                                                    <li>{{ __('frontstaticword.PerQuestionMark') }}
                                                                                        <i class="fa fa-long-arrow-right"></i>
                                                                                    </li>
                                                                                    <li>{{ __('frontstaticword.TotalMarks') }}
                                                                                        <i class="fa fa-long-arrow-right"></i>
                                                                                    </li>
                                                                                    <li>{{ __('frontstaticword.TotalQuestions') }}
                                                                                        <i class="fa fa-long-arrow-right"></i>
                                                                                    </li>
                                                                                    <li>{{ __('frontstaticword.QuizPrice') }}
                                                                                        <i class="fa fa-long-arrow-right"></i>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                        ...
                                                                        @if(empty($users))
                                                                            @if($quiz_question != null || $quiz_question!= '')
                                                                                ...
                                                                                <a href="{{route('start_quiz', ['id' => $topic->id])}}"
                                                                                   class="btn btn-block"
                                                                                   title="Start Quiz"> {{ __('frontstaticword.StartQuiz') }}</a>

                                                                            @endif
                                                                        @else
                                                                            <a href="{{route('start.quiz.show',$topic->id)}}"
                                                                               class="btn btn-block">{{ __('frontstaticword.ShowQuizReport') }} </a>
                                                ...
                                                <div class="modal fade" id="assignmodel" role="dialog"
                                                    ...
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title"
                                                                    id="myModalLabel">{{ __('frontstaticword.SubmitAssignment') }}</h4>
                                                                        ...
                                                                        <form id="demo-form2" method="post"
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputDetails">{{ __('adminstaticword.ChapterName') }}
                                                                                            :<sup class="redstar">*</sup></label>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="wrapper">
                                                                                            <label for="detail">{{ __('frontstaticword.AssignmentUpload') }}
                                                                                                :<sup class="redstar">*</sup></label>
                                            ...
                                            @foreach($appointment as $appoint)
                                                <div class="col-md-12">
                                                    <div class="assignment-tab-block">
                                                        <div class="categories-block assign-tab-one text-center">
                                                            <ul>
                                                                <li class="btm-5"><span>{{ $appoint->title }}</span>
                                                                </li>
                                                                <li class="btm-5"><span>{!! $appoint->detail !!}</span>
                                                                </li>
                                                                <li>
                                                                    ...
                                                                    <form method="post"
                                                                        ...
                                                                        <button type="submit"
                                                                                class="cart-remove-btn display-inline"
                                                                                title="Remove From cart"> {{ __('frontstaticword.Delete') }}</button>
                                                                    </form>

                                                                </li>
                                                                @if($appoint->accept == 1)
                                                                    <li><a href="" data-toggle="modal"
                                                                           data-target="#myModalresponse"
                                                                           title="response">Response</a></li>

                                                                    <div class="modal fade" id="myModalresponse"
                                                                         tabindex="-1" role="dialog"
                                                                         aria-labelledby="myModalLabel">
                                                                        <div class="modal-dialog modal-lg"
                                                                             role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    ...
                                                                                    <h4 class="modal-title"
                                                                                        id="myModalLabel">{{ __('frontstaticword.Response') }}</h4>
                                                                                    <button type="button" class="close"
                                                                                            data-dismiss="modal"
                                                                                            ...
                                                                                            <div class="instructor-detail">
                                                                                                <ul>
                                                                                                    ...
                                                                                                    <li>
                                                                                                        ...
                                                                                                        : {{ $appoint->instructor->fname }} {{ $appoint->instructor->lname }}
                                                                                                    </li>
                                                                                                    <li>
                                                ...
                                                <div class="modal fade" id="appointmodel" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title"
                                                                    id="myModalLabel">{{ __('frontstaticword.RequestAppointment') }}</h4>
                                                                <button type="button" class="close" data-dismiss="modal"
                                                                        aria-label="Close"><span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form id="demo-form2" method="post"
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="title">{{ __('frontstaticword.User') }}
                                                                                            :<sup class="redstar">*</sup></label>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="title">{{ __('frontstaticword.Instructor') }}
                                                                                            :<sup class="redstar">*</sup></label>
                                                                                        <input type="text"
                                                                                               name="instructor"
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="title">{{ __('frontstaticword.Date') }}
                                                                                            :<sup class="redstar">*</sup></label>
